...
insert into blog(uername, password, bio, name, created_at, email, age) values('luisa', 'lusa', 'nine', 'unisa', '2018-08-09', 'lu@gmail.com', '26');
...
delete from blog where username='to_delete';
delete from blog where email='test@test.com';
